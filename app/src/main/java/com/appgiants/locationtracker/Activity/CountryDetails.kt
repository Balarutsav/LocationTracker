...
class CountryDetails : AppCompatActivity() {
    ...
    val maps: HashMap<String?, LatLng?> = object : HashMap<String?, LatLng?>() {
        init {
    ...
    fun init(){
        ...
        binding.btnViewOnMap.setOnClickListener{
            Log.e("tag",country.alpha2)
            var list=maps[country.alpha2]
            list?.let { it1 -> openMap(it1.latitude,list.longitude) }
        }
