...
public class NotificationBadge {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public void run() {
                        if (ApplicationClass.context != null) {
                            ApplicationClass.context.sendBroadcast(intent);
                        }
                    }
                });
            }
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString("package", ApplicationClass.context.getPackageName());
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ApplicationClass.context.getContentResolver().call(Uri.parse("content://com.huawei.android.launcher.settings/badge/"), "change_badge", null, localBundle);
                    } catch (Exception e) {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (canResolveBroadcast(intent1) || canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
                        ApplicationClass.context.sendBroadcast(intent1);
                        ApplicationClass.context.sendBroadcast(intent);
                    }
                });
            }
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            ApplicationClass.context.getContentResolver().insert(Uri.parse(CONTENT_URI), contentValues);
        }
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            try {
                ...
                ApplicationClass.context.getContentResolver().call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, extras);
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(ApplicationClass.context.getApplicationContext().getContentResolver()) {
        ...
        private static boolean sonyBadgeContentProviderExists() {
            ...
            ProviderInfo info = ApplicationClass.context.getPackageManager().resolveContentProvider(SONY_HOME_PROVIDER_NAME, 0);
            if (info != null) {
                exists = true;
            }
            return exists;
            ...
            try {
                ...
                if (canResolveBroadcast(localIntent)) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        @Override
                        public void run() {
                            ApplicationClass.context.sendBroadcast(localIntent);
                        }
                    });
                }
            }
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ApplicationClass.context.getContentResolver().call(CONTENT_URI, "setAppBadgeCount", null, extra);
                    } catch (Exception e) {
    ...
    public static class VivoHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            intent.putExtra("packageName", ApplicationClass.context.getPackageName());
            intent.putExtra("className", componentName.getClassName());
    ...
    private static boolean canResolveBroadcast(Intent intent) {
        PackageManager packageManager = ApplicationClass.context.getPackageManager();
